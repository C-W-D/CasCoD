...
save_type="hf"
train_data_path="./dataset/bbh/bbh_all_data/all_task_train_right_wronghint_answer.json" # for the 1st step in edit
...
torchrun --nnodes 1 --nproc_per_node 4 --master-port 29506 ./finetuning.py \
    --max_words $max_words \
